  ...
  <div  class="popup_login_content">
    ...
    <div id="regTable">
      <table cellpadding="0" cellspacing="0" class="popUpTable">
        ...
        <tr>
          <td  class="padLeft smallFont" height="92" id="forget_back">Enter your email address and we'll send you an email with instructions to reset your password.</td>
        </tr>
        <tr>
          <td class="blankRow" id="forgetWrongPass"></td>
        </tr>
        <tr>
          <td  height="56"  ><div id="btnForget" class="btn">continue</div><div id="btnClose" class="btn hidden">Close</div></td>
        </tr>
        <tr>
          <td class="blankRow"></td>
        </tr>
  ...
  <div  class="popup_login_content">
    ...
    <div id="regTable2">
      <table width="300" cellpadding="0" cellspacing="0" class="popUpTable">
        ...
        <tr>
          <td colspan="5" class="padCheck smallFont"><table cellpadding="0" cellspacing="0">
            <tr>
              ...
              <td class="middleFont padLeftMin"> Remember my email on this computer</td>
            </tr>
          </table></td>
        </tr>
        <tr>
        ...
        <tr>
          <td colspan="5" height="56"  ><div id="pop_btnLogin"  class="btn">Login</div></td>
        </tr>
        <tr>
  ...
  <div  class="popup_login_content">
    ...
    <div id="signUpContent">
      <table cellpadding="0" cellspacing="0" class="popUpTable">
        ...
        <tr>
          <td colspan="5" height="56"  ><div id="btnSignup" class="btn">Sign Up</div></td>
        </tr>
        <tr>
          <td colspan="5" height=10></td>
        </tr>
  ...
  <div  class="popup_login_content">
    ...
    <div id="resetContent">
      <table cellpadding="0" cellspacing="0" class="popUpTable">
        ...
        <tr>
          <td colspan="5" height="40"  ><div id="btnResetPass" class="btn">reset</div></td>
        </tr>
