  ...
  <div class="inputArea" id="newlogin">
      <table cellpadding="0" cellspacing="0" >
        <tr >
          ...
          <td width="9"></td>
          <td width="68" align="center"><div id="up_btnLogin" class="btn">Login</div></td>
          <td width="2"></td>
          <td width="78" id="regtable"><div id="reg" class="btn">Sign Up</div></td>
        </tr>
        <tr>
     ...
     <div class="inputArea" id="alreadylogin">
      <table cellpadding="0" cellspacing="0" >
        <tr>
          <td class="G_smallText" height=31><span id="btn_profile" >My Profile</span></td>
          <td width="10"></td>
          <td class="G_smallText"><span id="btn_Guide">User Guide</span></td>
          <td width="10"></td>
          <td width="78"><div id="logout" class="btn">Logout</div></td>
        </tr>
