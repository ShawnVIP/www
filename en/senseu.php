  ...
  <div class="G_middleGreenText" style="top:42px;left:80px"> loading, please wait.</div></div>
    ...
    <!---分割线-->
     ...
     <div class="G_bigRoundShadowSpc friendContent" id="Frame_FRI">
        ...
        <div class="absDiv" id="FAM_cenLabel">Family Goal Achieved</div>
        <div id="percentageType">
        <table>
        <tr><td><img src="../images/se_yes.png" id="perCheckImg1" /></td><td><div  class="familyPercentTypeMenu" id="perCheckTxt1" >Calories</div></td></tr>
        <tr><td><img src="../images/se_no.png" id="perCheckImg2" /></td><td><div  class="familyPercentTypeMenu" id="perCheckTxt2" >Distance</div></td></tr>
        <tr><td><img src="../images/se_no.png" id="perCheckImg0" /></td><td><div  class="familyPercentTypeMenu" id="perCheckTxt0" >Step</div></td></tr>
       <!--
       <tr><td><img src="../images/se_no.png" id="perCheckImg3" /></td><td><div  class="familyPercentTypeMenu" id="perCheckTxt3" >Sleep</div></td></tr>
       -->
       <tr><td height=20></td><td></td></tr>
       <tr><td><img src="../images/se_yes.png" id="perPerioImg0" /></td><td><div  class="familyPercentTypeMenu" id="perPerioTxt0" >Today</div></td></tr>
        <tr><td><img src="../images/se_no.png" id="perPerioImg1" /></td><td><div  class="familyPercentTypeMenu" id="perPerioTxt1" >This week</div></td></tr>
        <tr><td><img src="../images/se_no.png" id="perPerioImg2" /></td><td><div  class="familyPercentTypeMenu" id="perPerioTxt2" >This month</div></td></tr>
...
<div id="FAM_confirmRemove" class="G_bigRound templetes">
   <div id="FAM_info">
     <table width="100%"><tr><td  align="center" height=70><img src="../images/blank.gif" id="FAM_hideHead" width="70"  height=70/></td></tr>
     	   ...
     	   <tr><td class="FAM_bigInfo" height="120">Are you sure you want to remove this family member?</td></tr></table>
   	</div>
    <div id="FAM_confirm">confirm</div>
