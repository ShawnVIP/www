...
$sql="SELECT a.friendid, a.relation, b.nickname,a.guardian,a.becare, b.headimage, c." . $lang . "_name as relname FROM familylist as a, sensorinfo as b ,relation as c WHERE a.relation=c.id and  a.friend=$scode and b.id=a.friendid ". $extInfo;
