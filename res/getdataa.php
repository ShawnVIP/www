...
$json_string='{"type":"act","ucode":"7ZYSquiG2Q0BEibjMXpYJnPnydPgtIdUCq9M","scode":"1","dates":"2014-8-25","cdate":"2014-8-25 下午11:13:01","ecode":"dM8s6jZuTgOhkA90","source":"w"}';
...
if($havedata==1){
	$sql="SELECT stime,calories,steps,distance FROM basedata_$datestr where sensorid=$scode order by stime";
	$result=mysql_query($sql,$conn); 
