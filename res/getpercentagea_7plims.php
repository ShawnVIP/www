...
$json_string='{"type":"family","lang":"cn","ucode":"hIYtECrYZWgkgkiDvwTvOTkRMfdFtkDDXNjg","scode":"677","dates":"2014-9-17","cdate":"2014-9-17 下午5:27:51","ecode":"30N6RMBuPnwWGG7X","source":"w"}';
...
$sql="SELECT a.friendid, a.relation, b.nickname,a.guardian,a.becare, b.headimage, c." . $lang . "_name as relname FROM familylist as a, sensorinfo as b ,relation as c WHERE a.relation=c.id and  a.friendid=$scode and b.id=a.friendid ". $extInfo;
