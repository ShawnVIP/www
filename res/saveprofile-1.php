...
$uemail=$obj -> email;
$unickname=$obj -> nickname;
$ugender=$obj -> gender;
$uheight=$obj -> height;
$uweight=$obj -> weight;
$udob=$obj -> dob;
$utimezone=$obj -> timezone;
$ustepwidth=$obj -> stepwidth;
$uunit=$obj -> unit;

$ustepgoal=$obj-> stepgoal;
$ucaloriesgoal=$obj-> caloriesgoal;
$udistancegoal=$obj-> distancegoal;
...
array_push($updateList,  array('name'=>'caloriesgoal' ,'odata'=>$caloriesgoal,'ndata'=>$ucaloriesgoal,'lib'=>'goal'));
array_push($updateList,  array('name'=>'stepgoal' ,'odata'=>$stepgoal,'ndata'=>$ustepgoal,'lib'=>'goal'));
array_push($updateList,  array('name'=>'distancegoal' ,'odata'=>$distancegoal,'ndata'=>$udistancegoal,'lib'=>'goal'));
...
//$strs="email='$email',";
	...
	$stmt = $mysqli->stmt_init();
	$stmt = $mysqli->prepare($sql);
	$stmt->bind_param("sssssss", $nickname,$gender,$dob,$timezone,$unit,$age,$scode);
	$stmt->execute();
	$stmt->close();
