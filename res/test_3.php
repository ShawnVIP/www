...
$json_string='{"sensorid":"654","date":"2014-09-02"}';
...
function buildSensorStation($scode,$dateList){
	...
	for($i=0;$i<count($dateList);$i++){
		...
		if($firstStationTime != "00:00:00"){
			...
			array_shift($ordList, array('totime'=>$firstStationTime,'position'=>7,'lasttime'=>($firstStationTime-date("H:i:s",strtotime("00:00:00"))/60)));	
		}
		echo $ordList[0][totime] ." -" . $ordList[0][lasttime] . " minute";
