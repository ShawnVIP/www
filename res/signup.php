...
$sql = "insert into sensorinfo (unit,createdate,lastupdate,ip,userid,headimage,gender,seedkey,nickname) values ('Metric','$now','$now','$rip','$userid','avatar_m.gif','M','$kcode','unnaming')"; 
...
*/
echo json_encode(array('status'=>'201','userInfo'=>array('ucode'=>$userid,'scode'=>$scode,'ecode'=>$ecode,'kcode'=>$kcode),'userinfo'=>array('ucode'=>$userid,'scode'=>$scode,'ecode'=>$ecode,'kcode'=>$kcode)));
