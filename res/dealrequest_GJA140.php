...
$sql="insert into familylist (sensorid,friendid,sdate,relation,guardian,becare) values ($scode,$reqcode,'$now','$relforme',$guardian,$becare)";
$result=mysql_query($sql, $conn);
...
$sql="insert into familylist (sensorid,friendid,sdate,relation,guardian, becare) values ($reqcode,$scode,'$now','$reltome',$nguardian,$nbecare)";
